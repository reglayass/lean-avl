...
lemma delete_neq_key (t : btree α) (k x : nat) (h : k ≠ x) :
  bound x t = tt → bound x (delete k t) = tt :=
begin
  intro h₁,
  induction t,
  case empty {
